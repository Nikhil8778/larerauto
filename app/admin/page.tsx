  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-6">
        ...
        <StatCard title="Quote Leads" value={String(quoteLeadCount)} note="Pre-order quote pipeline." />
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            ...
            <a
              ...
              className="rounded-2xl border border-violet-200 bg-violet-50 px-4 py-3 text-sm font-bold text-violet-800"
            >
              View Quote Leads
            </a>
        ...
        <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          ...
          <div className="mt-4 space-y-3 text-sm text-slate-700">
            <div>• Review quote leads by source channel and reply route</div>
            <div>• Convert quote leads into paid orders</div>
            <div>• Verify inventory and update customers</div>
